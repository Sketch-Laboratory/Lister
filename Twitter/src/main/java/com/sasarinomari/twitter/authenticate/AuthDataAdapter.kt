...
import kotlinx.android.synthetic.main.item_user_token.view.*
...
internal class AuthDataAdapter(private val users: ArrayList<AuthData>,
    ...
    override fun getView(position: Int, _convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_user_token, parent, false)
        }
        ...
        convertView.button_more.setOnClickListener { v ->
            ...
            menu.inflate(R.menu.item_delete)
