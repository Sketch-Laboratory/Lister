package com.sasarinomari.permission;
...
import com.sasarinomari.framework.R;
...
public class PermissionHelper {
    ...
    public static void activatePermission(final Activity context, String[] permissions, Runnable callback) {
        ...
        int permissionResult = new PermissionRequester.Builder(context)
                ...
                .setPositiveButtonName(context.getString(android.R.string.yes))
                .setNegativeButtonName(context.getString(android.R.string.no))
                .create()
